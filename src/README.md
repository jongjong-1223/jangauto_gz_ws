...
* `jangauto_description` - holds the sdf description of the simulated system and any other assets.

* `jangauto_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `jangauto_application` - holds ros2 specific code and configurations.

* `jangauto_bringup` - holds launch files and high level utilities.

* `jangauto_navigation2` - Nav2 bringup template (launch files and params) for this robot.
