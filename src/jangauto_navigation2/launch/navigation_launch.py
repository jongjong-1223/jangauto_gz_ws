...
def generate_launch_description():
    ...
    # Note: RewrittenYaml.add_params() only inserts a *new* key into an existing
    # node's ros__parameters block if the key is given as a fully-qualified
    # '<node_name>.ros__parameters.<param>' path - a bare param name is a no-op
    # unless that exact key already exists somewhere in the source yaml.
    param_substitutions = {
        'autostart': autostart,
