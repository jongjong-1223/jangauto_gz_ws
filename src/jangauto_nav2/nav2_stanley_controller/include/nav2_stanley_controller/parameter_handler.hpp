...
#ifndef NAV2_STANLEY_CONTROLLER__PARAMETER_HANDLER_HPP_
#define NAV2_STANLEY_CONTROLLER__PARAMETER_HANDLER_HPP_
...
struct Parameters
{
  ...
  // Stanley 조향 법칙(references/stanley_ref/stanley.c 포팅) 파라미터.
  double stanley_wheelbase;
  double stanley_track_width;
  double stanley_min_turning_radius;
  double stanley_max_track_speed;
  double stanley_k;
  double stanley_k_soft;
  double stanley_max_steer_rad;
};

/**
 * @class nav2_stanley_controller::ParameterHandler
...
public:
  /**
   * @brief Constructor for nav2_stanley_controller::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destrructor for nav2_stanley_controller::ParameterHandler
   */
  ~ParameterHandler();
...
#endif  // NAV2_STANLEY_CONTROLLER__PARAMETER_HANDLER_HPP_
