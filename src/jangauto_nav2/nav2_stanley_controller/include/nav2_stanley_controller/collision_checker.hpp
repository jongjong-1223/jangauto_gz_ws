...
#ifndef NAV2_STANLEY_CONTROLLER__COLLISION_CHECKER_HPP_
#define NAV2_STANLEY_CONTROLLER__COLLISION_CHECKER_HPP_
...
/**
 * @class nav2_stanley_controller::CollisionChecker
...
public:
  /**
   * @brief Constructor for nav2_stanley_controller::CollisionChecker
   */
  CollisionChecker(
  ...
  /**
   * @brief Destrructor for nav2_stanley_controller::CollisionChecker
   */
...
#endif  // NAV2_STANLEY_CONTROLLER__COLLISION_CHECKER_HPP_
