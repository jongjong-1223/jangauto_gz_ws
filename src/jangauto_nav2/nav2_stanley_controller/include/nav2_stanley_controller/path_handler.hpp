...
#ifndef NAV2_STANLEY_CONTROLLER__PATH_HANDLER_HPP_
#define NAV2_STANLEY_CONTROLLER__PATH_HANDLER_HPP_
...
/**
 * @class nav2_stanley_controller::PathHandler
...
public:
  /**
   * @brief Constructor for nav2_stanley_controller::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destrructor for nav2_stanley_controller::PathHandler
   */
  ~PathHandler() = default;
...
#endif  // NAV2_STANLEY_CONTROLLER__PATH_HANDLER_HPP_
